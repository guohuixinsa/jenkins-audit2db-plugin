...
public interface BuildDetailsRepository {
    ...
    Object saveBuildJob(BuildJob buildjob);
    Object savnBuildChange(BuildChange buildChange);
    Object saveChangeFile(ChangeFile changfile);

   // Object saveBuildChange(BuildChange buildchange);
    //Object saveChangeFile(ChangeFile);
    //void updateBuildJob(BuildJob buildjob);
     ...
     */
    BuildDetails getBuildDetailsById(int id);
    ...
    List<BuildDetails> getBuildDetailesByJobId(int jobId);
    ...
    List<BuildDetails> getBuildDetailsBySvnRev(String svnRev);
    List<BuildDetails> getBuildDetailsBySvnUrl(String svnUrl);
    List<BuildDetails> getBuildDetailsByBuildNum(int   buildNum);
    ...
    //List<BuildChange> getBuildDetailsByBuildChange(BuildChange buildchange);
    /**
    ...
    int getCountBuildDetailsByName(String name);
    int getCountBuildSuccessByName(String name);
    ...
    BuildJob getBuildJobForBuild(AbstractBuild<?, ?> build);
   ...
   // Object saveBuildJobs(BuildJob jobName);
